    angular.module('openeApp.common.directives')
        .directive('tempFileDropUpload', tempFileDropUpload);
     
     function tempFileDropUpload(alfrescoUploadService, $timeout, fileUtilsService){
         return {
             restrict: 'E',
             templateUrl: 'app/src/common/directives/tempFileDropUpload/view/tempFileDropUpload.html',
             scope: {
                 form: '=',
                 filesModel: '=',
                 fileAddonSrc: '&',
         ...
         function link(scope){
             ...
             function uploadFiles(files){
                 ...
                 files.forEach(function(file){
                     ...
                     file.progress = 0;
                     file.upload = alfrescoUploadService.uploadTempFile(file).xhr(function(xhr){
                         file.abort = function(){
                             xhr.abort();
