(function(){
    ...
    StartParallelGroupReviewWorkflowController.$inject = ['$controller', 'userService', 'workflowDef'];
    
    function StartParallelGroupReviewWorkflowController($controller, userService, workflowDef) {
