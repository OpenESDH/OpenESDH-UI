 ...
 * @constructor
 */
function OfficeTemplateController($scope, $mdDialog, $translate, officeTemplateService, caseService, FileSaver, Blob) {
    var vm = this;
    ...
    function uploadTemplate() {
        showDialog(DocumentTemplateDialogController).then(function (response) {
    ...
    function showDialog(controller, locals) {
        ...
        return $mdDialog.show({
            controller: DocumentTemplateDialogController,
            controllerAs: "dtdc",
    ...
    function DocumentTemplateDialogController($scope, $mdDialog) {
        var tdc = this;

        tdc.selectedTypes=null;
        tdc.registeredTypes=null;
        tdc.registeredCaseTypes = getRegisteredCaseTypes();
        ...
        $scope.upload = function () {
            $scope.templateProperties.caseTypes = tdc.selectedTypes
            var response = {
        ...
        function getRegisteredCaseTypes() {
            return caseService.getRegisteredCaseTypes().then(function(response) {
                tdc.registeredTypes = response;
                return response;
            });
        }
    }
