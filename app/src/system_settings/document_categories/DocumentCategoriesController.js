    ...
    function DocumentCategoriesController($controller, documentCategoryService) {
        angular.extend(this, $controller('ClassifierValuesController', {classifierValuesService: documentCategoryService}));
        var vm = this;
